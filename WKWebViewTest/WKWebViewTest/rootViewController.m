...
@interface rootViewController ()<WKScriptMessageHandler,WKNavigationDelegate,WKUIDelegate,UINavigationControllerDelegate>
{
    WKWebView *kwebView;
...
- (void)viewDidLoad
{
    ...
    NSURL *url2 = [NSURL fileURLWithPath:htmlPath];
    
    
    
    
    urlReuqest = [[NSURLRequest alloc]initWithURL:url2 cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:30.0f];
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message{
    ...
    //******************************************             调用友盟分享              **********************************************
        ...
        [UMSocialUIManager showShareMenuViewInWindowWithPlatformSelectionBlock:^(UMSocialPlatformType platformType, NSDictionary *userInfo) {
            [self shareWebPageToPlatformType:platformType withInfo:message.body];
        }];
