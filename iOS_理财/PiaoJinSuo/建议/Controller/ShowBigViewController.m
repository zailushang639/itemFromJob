...
-(void)layOut{
    ...
    if (IOS7LATER)
    {
        ...
        _btnOK = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 76,  _scrollerview.frame.size.height + 9, 61, 32)];
    }
#endif
    ...
    NSLog(@"self.arrayOK.count is %ld",(unsigned long)self.arrayOK.count);
    ...
    [_btnOK setTitle:[NSString stringWithFormat:@"完成(%ld)",(unsigned long)self.arrayOK.count] forState:UIControlStateNormal];
